package md56e1d4134ebf242aad0007c7a1ca0826d;


public class MainActivity_Client
...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("WhatsOnSale.MainActivity+Client, WhatsOnSale", MainActivity_Client.class, __md_methods);
	}


	public MainActivity_Client ()
	{
		super ();
		if (getClass () == MainActivity_Client.class)
			mono.android.TypeManager.Activate ("WhatsOnSale.MainActivity+Client, WhatsOnSale", "", this, new java.lang.Object[] {  });
	}
